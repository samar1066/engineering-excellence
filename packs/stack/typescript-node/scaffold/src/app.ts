 ...
 * Routes receive their workflow through plugin options, which is what keeps src/routes free of
 * any import from src/infrastructure.
 */
export function createApp(): FastifyInstance {
  ...
  const workflow = new NotesWorkflow(new MemoryNoteRepository());
